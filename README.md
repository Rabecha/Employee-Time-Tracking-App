...
A simple Employee Time Tracking application built with Node.js, Express, MySQL, and Bootstrap. This repository includes a Docker Compose configuration to run the app together with MySQL for local development.
